      ...
      <div class="el-picker-panel__body-wrapper">
        ...
        <div class="el-picker-panel__body">
          <div class="el-date-picker__time-header" v-if="showTime">
            ...
            <span class="el-date-picker__editor-wrap el-picker-panel__input-box" v-clickoutside="handleTimePickClose">
              <el-input
                ref="input"
                @focus="handleTimeFocus('h')"
                :disabled="!visibleTime"
                :value="visibleTime.substring(0,2)"
                size="small"
              ...
              <el-input
                ...
                :disabled="!visibleTime"
                :value="visibleTime.substring(3,5)"
                size="small"
                @input="val => userInputTime = val"
                @change="handleVisibleTimeChange" />
              <span> : </span>
              <el-input
                @focus="handleTimeFocus('s')"
                :disabled="!visibleTime"
                :value="visibleTime.substring(6,8)"
                size="small"
                @input="val => userInputTime = val"
                @change="handleVisibleTimeChange" />
              <time-open ref="timepicker" 
                @pick="handleTimePick" 
                :date.sync="visibleTime"
...
export default {
  ...
  watch: {
    ...
    timePickerVisible(val) {
      if (val) {
        this.proxyTimePickerDataProperties()
  ...
  methods: {
    ...
    handleTimePick(value, type, visible, first) {
      // console.log(value, type, visible, first)
      if (isDate(value)) {
        // console.log(this.value, value.getHours(), value.getMinutes(), value.getSeconds())
    ...
    // 时分秒选中
    handleTimeFocus(type) {
      this.$refs.timepicker.type = type
